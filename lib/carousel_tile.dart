  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(children: [
          Container(margin: EdgeInsets.only(top: 70), padding: EdgeInsets.only(top: 20, bottom: 20), color: Colors.black, child: Text('Título Categoria', style: TextStyle(fontSize: 35, color: Colors.white)))
        ]));
  }
}
