  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(children: [
          Container(margin: EdgeInsets.only(top: 70), padding: EdgeInsets.only(top: 10, bottom: 10), color: Colors.black, child: Text('Título Categoria', style: TextStyle(fontSize: 35, color: Colors.white)))
        ]));
  }
}
