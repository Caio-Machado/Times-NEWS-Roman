  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(children: [
          Container(margin: EdgeInsets.only(top: 70), color: Colors.black, child: Text('Título Categoria', style: TextStyle(fontSize: 35, backgroundColor: Colors.black, color: Colors.white)))
        ]));
  }
}
